...
- (void)resignUM{
    //这个表示来自于  在UM 开发平台注册 完应用 给的 appKey
    [UMSocialData setAppKey:@"561cb9cfe0f55ab327002433"];
    
    [UMSocialWechatHandler setWXAppId:@"wxc850607934f30c31" appSecret:@"12f4bd1e82ca8fae52022413b0efdeb9" url:@"http://www.umeng.com/social"];//这个回调URL  必须要和 后台的保持一致
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.1519.HealthyGood" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"HealthyGood" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"HealthyGood.sqlite"];
    NSError *error = nil;
